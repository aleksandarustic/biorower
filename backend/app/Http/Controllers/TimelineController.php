...
class TimelineController extends Controller {
	...
	public static function index($id2)
	{
		$posts = Timeline::where('timeline.user_id', $id2)
						...
						->select('timeline.time', 'timeline.object_id', 'timeline.type', 'sessions.description', 'sessions.name', 'data_biorower_sessions.distance', 'data_biorower_sessions.time as totaltime', 'data_biorower_sessions.stroke_count', 'images.name as image', 'timeline.coms')
						->orderBy('time', 'desc')
					    ->get();
